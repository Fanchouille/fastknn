...
dist_types = {"float": nmslib.DistType.FLOAT,
              "double": nmslib.DistType.DOUBLE,
              "int": nmslib.DistType.INT}


class NMSIndexer(object):
    def __init__(self, method="hnsw", space='cosinesimil', data_type="dense", dist_type="float", M=20, efC=200,
                 num_threads=4, index_path=None):
